...
class PagePerfTimer(object):
    ...
    def login_to_galaxy_homepage(self):
        ...
        self.wait.until(
            expected_conditions.presence_of_element_located(
                (By.XPATH, "//div[@class='tool-panel-section']//a[contains(@class, 'title-link') and contains(., 'Get Data')]")
            )
        )
    ...
    def load_published_histories(self):
        ...
        self.wait.until(
            expected_conditions.presence_of_element_located(
                (By.XPATH, "//li[@id='histories-published-tab' and contains(., 'Public Histories')]")
            )
        )
    ...
    def load_workflow_run_form(self):
        ...
        self.wait.until(lambda d: len(d.find_elements(By.CSS_SELECTOR, '#workflow-cards .workflow-card')) == 1)
